...
var SM = util_1.extend(true, {}, XY, {
    ...
    'Double Kick': { zp: 100, maxPower: 80 },
    'Draco Meteor': { zp: 195 },
...
var MOVES_BY_ID = [];
for (var _i = 0, MOVES_1 = exports.MOVES; _i < MOVES_1.length; _i++) {
    var moves = MOVES_1[_i];
    var map = {};
    for (var move in moves) {
        var data = moves[move];
        var m = new Move(move, data);
        map[m.id] = m;
    }
